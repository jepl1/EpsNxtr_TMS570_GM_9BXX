...
/*****************************************************************************
* Copyright 2017-15,2012 Nexteer 
 ...
 *********************************************************************************************************************/
  ...
  */
   ...
   * Rationale: Deviation is allowed till decision is made about fixing the warnings in Nexteer Libraries. */
   ...
   * Rationale: Deviation required due to use of Nexteer macro library functions. */
  ...
  /* MISRA-C:2004 Rule 21.1: Deviation is allowed till decision is made about fixing the warnings in Nexteer Libraries. 
