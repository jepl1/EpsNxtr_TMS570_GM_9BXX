...
/* ----------------------------------------------------------------------------
  ...
  demonstration purposes only, Vector Informatiks liability shall be expressly
...
STATIC VAR(boolean, APPDESC_VAR_NOINIT) NexteerKeyAllowed_Cnt_M_lgc;
...
STATIC VAR(boolean, APPDESC_VAR_NOINIT) NexteerModeEntered_Cnt_M_lgc;
...
FUNC(void, RTE_APPDESC_APPL_CODE) AppDesc_Init(void)
{
	...
	NexteerKeyAllowed_Cnt_M_lgc= FALSE;
...
FUNC(void, RTE_APPDESC_APPL_CODE) AppDesc_Per1(void)
{
	...
	if (
		((NexteerModeEntered_Cnt_M_lgc == TRUE) && (TimeoutElapsedTime_mS_T_u32p0 > (uint32)k_NexteerModeTO_mS_u16p0)) ||
		((CPIDAE08Performed_Cnt_M_lgc == TRUE) && (TimeoutElapsedTime_mS_T_u32p0 > 5000U))
	   )
	{
		ApplDescOnReturnToNormalMode(); /* Calling this function would essentially exit you out of Nexteer mode */
		RespMsgBuffer[0] = 0x60U;
		DescTransmitSingleFrame(RespMsgBuffer, 1U); /* Manual handling of Nexteer Mode exit asks for sending the positive response manually */
	}
...
void ApplDescOnReturnToNormalMode(void)
{
	...
	NexteerModeEntered_Cnt_M_lgc = FALSE;
	CPIDAE08Performed_Cnt_M_lgc = FALSE;
}
...
vuint8 DESC_API_CALLBACK_TYPE ApplDescCheckUserService(DescMsgItem sid)
{
	...
	{
		case 0x31u:
			if (kDescStateDiagnostic_ModeNexteer_Mode == DescGetStateDiagnostic_Mode())
			{
...
/*  ********************************************************************************
 * Function name:ApplDescStartStart_Nexteer_Mode (Service request header:$10 $7E )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	DescSetStateDiagnostic_Mode(kDescStateDiagnostic_ModeNexteer_Mode);
	GetSystemTime_mS_u32(&(ResetTesterPresentTimer_mS_M_u32p0));
	NexteerModeEntered_Cnt_M_lgc = TRUE;
...
/*  ********************************************************************************
 * Function name:ApplDescRequestNexteer_Seed (Service request header:$27 $FB )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescRequestNexteer_Seed(DescMsgContext* pMsgContext)
{
	...
	if ( (D_SECURITYDELAYTIME_MS_U32 < TimeoutElapsedTime_mS_T_u32) || (FALSE == SecurityTimeArmed_Cnt_M_lgc) )
	{
		if (DescGetStateSecurity_Access() != kDescStateSecurity_AccessNexteer_Unlock)
		{
			NexteerKeyAllowed_Cnt_M_lgc = TRUE;
			pMsgContext->resData[0] = Nvm_NexteerSeed_Cnt_str.Data.Seed[0]; /* PRQA S 0491 */
			pMsgContext->resData[1] = Nvm_NexteerSeed_Cnt_str.Data.Seed[1]; /* PRQA S 0491 */
			pMsgContext->resData[2] = Nvm_NexteerSeed_Cnt_str.Data.Seed[2]; /* PRQA S 0491 */
			pMsgContext->resData[3] = Nvm_NexteerSeed_Cnt_str.Data.Seed[3]; /* PRQA S 0491 */
			pMsgContext->resData[4] = Nvm_NexteerSeed_Cnt_str.Data.Seed[4]; /* PRQA S 0491 */
		}
		else
		{
			DescActivateS1Timer();  /* start the tester present timer  */
...
/*  ********************************************************************************
 * Function name:ApplDescSendNexteer_Key (Service request header:$27 $FC )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	if (NexteerKeyAllowed_Cnt_M_lgc == TRUE)
	{
		NexteerKeyAllowed_Cnt_M_lgc = FALSE;
		
		/* PRQA S 0491 5 */
		if ((pMsgContext->reqData[0U] != Nvm_NexteerKey_Cnt_str.Data.Key[0U]) ||
			(pMsgContext->reqData[1U] != Nvm_NexteerKey_Cnt_str.Data.Key[1U]) ||
			(pMsgContext->reqData[2U] != Nvm_NexteerKey_Cnt_str.Data.Key[2U]) ||
			(pMsgContext->reqData[3U] != Nvm_NexteerKey_Cnt_str.Data.Key[3U]) ||
			(pMsgContext->reqData[4U] != Nvm_NexteerKey_Cnt_str.Data.Key[4U]))
		{
		...
		else
		{
			BadKeyCounterNXT_Cnt_M_u16 = 3U;
			DescActivateS1Timer();  /* start the tester present timer  */
			DescSetStateSecurity_Access(kDescStateSecurity_AccessNexteer_Unlock);
		}
	}
	else
	{
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD01_Internal_Software_Identifier (Service request header:$22 $FD $1 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD02_Serial_Comm_Service_Active (Service request header:$22 $FD $2 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD07_End_of_Line_Polarity (Service request header:$22 $FD $7 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD08_END_OF_LINE_TORQUE_SENSOR_SCALING_ANALOG (Service request header:$22 $FD $8 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFD08_END_OF_LINE_TORQUE_SENSOR_SCALING_ANALOG(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD0B_Wheel_Imbalance_Rejection_Selection (Service request header:$22 $FD $B )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD0E_Motor_Stiffness_Check (Service request header:$22 $FD $E )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD10_CCP_XCP_Transmit_and_Receive_IDs (Service request header:$22 $FD $10 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD13_Nexteer_Diagnostic_Trouble_Codes (Service request header:$22 $FD $13 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD17_Flash_Memory_Size_Read (Service request header:$22 $FD $17 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD19_Nexteer_Manufacturing_Enable_Counter (Service request header:$22 $FD $19 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD1A_System_State (Service request header:$22 $FD $1A )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD1B_Manual_Vehicle_Speed_Override (Service request header:$22 $FD $1B )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD1C_Manufacturing_Services_Version (Service request header:$22 $FD $1C )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD1E_Manufacturing_Diagnostic_Defeat (Service request header:$22 $FD $1E )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD20_Transient_Overvoltage_Data (Service request header:$22 $FD $20 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD25_Motor_Torque_Scale_Factor (Service request header:$22 $FD $25 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD26_Average_Friction_Learning_Select (Service request header:$22 $FD $26 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD27_Average_Friction_Offset_Output_Defeat (Service request header:$22 $FD $27 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD29_Set_EOL_Friction_Learned (Service request header:$22 $FD $29 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD30_EOL_Torque_Trim_Digital_SENT (Service request header:$22 $FD $30 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD31_Torque_Sensor_Value_Digital_SENT (Service request header:$22 $FD $31 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFD33_Current_Mode_Offset_and_Gain_3_Phs (Service request header:$22 $FD $33 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFD33_Current_Mode_Offset_and_Gain_3_Phs(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDA1_ECU_Serial_Number (Service request header:$22 $FD $A1 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDA2_EPS_Serial_Number (Service request header:$22 $FD $A2 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDA3_ECU_Hardware_Part_Number (Service request header:$22 $FD $A3 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDAC_Manufacturing_Scratchpad (Service request header:$22 $FD $AC )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDAD_Active_Pull_Compensation (Service request header:$22 $FD $AD )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDAE_Ignition_Counter (Service request header:$22 $FD $AE )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDAF_Fault_Information_Black_Box (Service request header:$22 $FD $AF )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB0_IPM_Cogging_Tbl_1 (Service request header:$22 $FD $B0 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB1_IPM_Cogging_Tbl_2 (Service request header:$22 $FD $B1 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB2_IPM_Cogging_Tbl_3 (Service request header:$22 $FD $B2 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB3_IPM_Cogging_Tbl_4 (Service request header:$22 $FD $B3 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB4_Current_Mode_Analog_Ke_R_Ld_and_Lq (Service request header:$22 $FD $B4 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB5_Active_Pull_Short_Term_Value (Service request header:$22 $FD $B5 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB6_Active_Pull_Long_Term_Value (Service request header:$22 $FD $B6 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB7_IPM_Cogging_Tbl_5 (Service request header:$22 $FD $B7 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB8_Ch_1_Analog_Handwheel_Diff_Torque_Trim (Service request header:$22 $FD $B8 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDB8_Ch_1_Analog_Handwheel_Diff_Torque_Trim(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDB9_Ch_2_Analog_Handwheel_Diff_Torque_Trim (Service request header:$22 $FD $B9 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDB9_Ch_2_Analog_Handwheel_Diff_Torque_Trim(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBA_Polarity (Service request header:$22 $FD $BA )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBA_Polarity(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBB_End_of_Line_Torque_Sensor_Analog (Service request header:$22 $FD $BB )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBB_End_of_Line_Torque_Sensor_Analog(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBC_Mtr_Pos_BEMF (Service request header:$22 $FD $BC )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBC_Mtr_Pos_BEMF(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBD_MtrPos1aHarCompTb (Service request header:$22 $FD $BD )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBD_MtrPos1aHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBE_MtrPos1bHarCompTb (Service request header:$22 $FD $BE )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBE_MtrPos1bHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDBF_MtrPos1cHarCompTb (Service request header:$22 $FD $BF )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDBF_MtrPos1cHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC0_MtrPos1dHarCompTb (Service request header:$22 $FD $C0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC0_MtrPos1dHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC1_MtrPos1HarCRC (Service request header:$22 $FD $C1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC1_MtrPos1HarCRC(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC2_MtrPos2aHarCompTb (Service request header:$22 $FD $C2 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC2_MtrPos2aHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC3_MtrPos2bHarCompTb (Service request header:$22 $FD $C3 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC3_MtrPos2bHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC4_MtrPos2cHarCompTb (Service request header:$22 $FD $C4 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC4_MtrPos2cHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC5_MtrPos2dHarCompTb (Service request header:$22 $FD $C5 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC5_MtrPos2dHarCompTb(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC6_MtrPos2HarCRC (Service request header:$22 $FD $C6 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC6_MtrPos2HarCRC(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC7_AnalogMtrPos (Service request header:$22 $FD $C7 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC7_AnalogMtrPos(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC8_Mtr_Pos_Coefficient_Table_1 (Service request header:$22 $FD $C8 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC8_Mtr_Pos_Coefficient_Table_1(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDC9_Mtr_Pos_Coefficient_Table_2 (Service request header:$22 $FD $C9 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDC9_Mtr_Pos_Coefficient_Table_2(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDCA_Sensor_Learning_Vehicle_Yaw_Rate_Offset (Service request header:$22 $FD $CA )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDCA_Sensor_Learning_Vehicle_Yaw_Rate_Offset(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDCB_Sensor_Learning_Handwheel_Angle_Offset (Service request header:$22 $FD $CB )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDCB_Sensor_Learning_Handwheel_Angle_Offset(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDCC_Sensor_Learning_Handwheel_Torque_Offset (Service request header:$22 $FD $CC )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDCC_Sensor_Learning_Handwheel_Torque_Offset(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFDCD_Torque_Sensor_Values (Service request header:$22 $FD $CD )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFDCD_Torque_Sensor_Values(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE0_System_Name_or_Engine_Type (Service request header:$22 $FE $E0 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE1_Diagnostic_Data_Identifier (Service request header:$22 $FE $E1 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE2_Manufacturing_Traceability_PCB_Manufacturing (Service request header:$22 $FE $E2 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE5_Read_Sensor_Torque_EEPROM (Service request header:$22 $FE $E5 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE6_End_Model_Part_Number (Service request header:$22 $FE $E6 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE7_End_Model_Part_Number_Alpha_Code (Service request header:$22 $FE $E7 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEE8_Manufacturing_Traceability_Nexteer_Plant (Service request header:$22 $FE $E8 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEEA_GM_Manufacturing_Enabale_Counter_MEC (Service request header:$22 $FE $EA )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEEB_Programming_Data (Service request header:$22 $FE $EB )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEEC_Repair_Shop_Code (Service request header:$22 $FE $EC )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEED_VIN_Data (Service request header:$22 $FE $ED )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEEF_WIR_Fault_Status_Information (Service request header:$22 $FE $EF )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF1_Data_Universal_Numbering_System_DUNS (Service request header:$22 $FE $F1 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF3_Base_Model_Part_Number (Service request header:$22 $FE $F3 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF4_Base_Model_Part_Number_Alpha_Code (Service request header:$22 $FE $F4 )
 * Description: not available
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF5_ECU_ID (Service request header:$22 $FE $F5 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF6_Motor_Variant (Service request header:$22 $FE $F6 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFEF6_Motor_Variant(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF7_Limp_Home_Ignition_Counter (Service request header:$22 $FE $F7 )
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFEF7_Limp_Home_Ignition_Counter(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescRead_Parameter_IdentifierNexteer_0xFEF8_Get_Sensor_Data (Service request header:$22 $FE $F8 )
 * Description:Used to reset the Limp Home Mode threshold counter.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescRead_Parameter_IdentifierNexteer_0xFEF8_Get_Sensor_Data(DescMsgContext* pMsgContext)
{
	ApplDesc_ReadByCms(pMsgContext);
}
