...
extern VAR(uint8, NVM_APPL_DATA) Nvm_NexteerSeed_Cnt_str[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_NexteerKey_Cnt_str[];
...
#include "MemMap.h"
    ...
    /* block descriptor user block NVM_BLOCK_SER_SEED_NEXTEER */
    ,{
        (NvM_RamAddressType)&Nvm_NexteerSeed_Cnt_str /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_KEY_NEXTEER */
    ,{
        (NvM_RamAddressType)&Nvm_NexteerKey_Cnt_str /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
