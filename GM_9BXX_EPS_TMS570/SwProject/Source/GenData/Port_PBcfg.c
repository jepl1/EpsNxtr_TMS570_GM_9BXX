...
FUNC(void, PORT_PBCODE) Port_InitPortRegs0( void ) /* PRQA S 3408 *//* MD_PORT_8.8 */
{
    ...
    PORT_WRITE_REGISTER_32BIT_SUPERVISOR_INIT((uint32)&PORT_BASE_ADDR_PINMUX_2->Mux.GnrlRg_u32, (uint32)(0x04010108u), OS_MEM_AREA_IOMM);    /* Configuration of PINMUX_2 Register */ /* PRQA S 303 *//* MD_PORT_11.3 */ /* NEXTEER MANUAL EDIT FOR EPWM MODULE */
